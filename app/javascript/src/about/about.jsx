        ...
        <div className="container">
          ...
          <div className="row aboutRow mb-5">
            ...
            <div className="col-12 col-lg-8 my-md-auto pt-md-5 ps-md-5">
              <h4 className="bodySection lh-lg text-black">Collin is an adaptive and creative junior full-stack web developer with proficiency in front-end programming languages such as: HTML, CSS, and ReactJS; Back-end programming knowledge in JavaScript and Ruby, as well as, experience conducting user research and collaborating with developers to build dynamic websites. Professional strengths include problem-solving, communication and time management. Analytical and leadership mindset from experience in Operations Management.</h4>
            </div>
            </Slide>
