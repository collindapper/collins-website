        ...
        <div className="container">
          ...
          <div className="row aboutRow mt-5">
            ...
            <div className="col-12 col-lg-8 my-md-auto pt-md-4 ps-md-5">
              <h1 className="text-black"><strong>Full-Stack Developer - collindapper.com</strong></h1>
              ...
              <h5 className="text-black">Drafted, Wire-framed, and wrote well-designed, testable and efficient code using the best software development practice.
              ...
              <h5 className="text-black">Lead a team of hourly workforce and engaged my team during their shifts to maintain the highest levels of safety, quality,
